...
Route::group(['prefix' => 'admin',  'middleware' => 'adminpanel'], function()
{
    ...
    ///////////////////////////------Modification-------////////////////////
        ...
        Route::get('/offers/addgrouplist',[OffergroupController::class, 'addgroupofferlist'])->name('admin.offers.addoffergrouplist');
        Route::get('/offers/addgroup',[OffergroupController::class, 'addgroupoffer'])->name('admin.offers.addoffergroup');
